...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://root:Caleb2048!@localhost/marvel'
...
def create_database():
    root_engine = create_engine("mysql+mysqlconnector://root:Caleb2048!@localhost")  # No database specified
